 ...
 *
 * Credits: https://www.anychart.com/
 */
 
DROP TABLE fxgn_world_population_details;

------------------------------------------------------------------------

CREATE TABLE fxgn_world_population_details 
    AS SELECT country, 
              population, 
              CATEGORY, 
              'Admin' updated_by, 
              LOCALTIMESTAMP updated_on
  FROM dual,
  json_table ('{
   "data":[
      {
...
}', '$.data[*]' COLUMNS (country VARCHAR2(100) path '$.x', 
                         population VARCHAR2(100) path '$.value', 
